...
<form class="form-horizontal" method="POST" action=" {{ route('location.store') }} " enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" name="location" placeholder="Location Name" value="{{ old('location') }}" required>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <input type="text" class="form-control" name="hospital" placeholder="Hospital Name" value="{{ old('hospital') }}" required>
        </div>
    </div>
